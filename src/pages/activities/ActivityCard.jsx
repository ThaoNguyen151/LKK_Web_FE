...
export function ActivityCard({ item, className }) {
  ...
  return (
    <article
      className={cn(
        'group relative flex overflow-hidden rounded-2xl border-2 border-white bg-white/10 backdrop-blur-[3px] transition-all duration-300',
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center gap-2 bg-white/75 opacity-0 backdrop-blur-[3px] transition-opacity duration-300 group-hover:pointer-events-auto hover:bg-white/10 group-hover:opacity-100 sm:gap-5">
        <a
          href={videoHref}
